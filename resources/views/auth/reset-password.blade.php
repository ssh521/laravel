...
<x-auth-card>
    ...
    <div class="w-full mx-auto max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        <form class="space-y-6" action="{{ route('password.update') }}" method="POST">
            ...
            @csrf
            <h5 class="text-xl font-medium text-gray-900 dark:text-white">비밀번호 재설정하기</h5>
            ...
            <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">비밀번호 재설정하기</button>
        </form>
    </div>
